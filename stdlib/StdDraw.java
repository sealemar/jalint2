 ...
 *
 *  Standard drawing library. This class provides a basic capability
 *  for
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * It is Pantone 300U. The RGB values are approximately (9, 90,
     * 166).
     */
     ...
     * It is Pantone 1805U. The RGB values are approximately (150, 35,
     * 31).
     */
    ...
    private static void init() {
        ...
        frame.addKeyListener(std);    // JLabel cannot get keyboard
                                      // focus
    ...
    /**
     * Set the x-scale and y-scale (a 10% border is added to the
     * values)
    ...
    /**
     * Set the pen color to the given color. The available pen colors
     * are
     ...
     * @throws RuntimeException if the radius of the circle is
     * negative
     */
    ...
    /**
     * Draw an arc of radius r, centered on (x, y), from angle1 to
     * angle2 (in degrees).
     * @param x the x-coordinate of the center of the circle
     * @param y the y-coordinate of the center of the circle
     * @param r the radius of the circle
     * @param angle1 the starting angle. 0 would mean an arc beginning
     * at 3 o'clock.
     * @param angle2 the angle at the end of the arc. For example, if
     *        you want a 90 degree arc, then angle2 should be angle1 +
     *        90.
     * @throws RuntimeException if the radius of the circle is
     * negative
     */
    ...
    /**
     * Draw a rectangle of given half width and half height, centered
     * on (x, y).
    ...
    /**
     * Draw a filled rectangle of given half width and half height,
     * centered on (x, y).
     * @param x the x-coordinate of the center of the rectangle
     * @param y the y-coordinate of the center of the rectangle
     * @param halfWidth is half the width of the rectangle
    ...
    /**
     * Write the given text string in the current font, centered on
     * (x, y).
     ...
     * <tt>square()</tt>
     * will not be displayed on screen until the next call to
     * <tt>show()</tt>.
     * This is useful for producing animations (clear the screen, draw
     * a bunch of shapes,
     * display on screen for a fixed amount of time, and repeat). It
     * also speeds up
     * drawing a huge number of shapes (call <tt>show(0)</tt> to defer
     * drawing
     * on screen, draw the shapes, and call <tt>show(0)</tt> to
     * display them all
     * on screen at once).
    ...
    /**
     * What is the next key that was typed by the user? This method
     * returns
     * a Unicode character corresponding to the key typed (such as 'a'
     * or 'A').
