...
/**
 *  <i>Binary standard input</i>. This class provides methods for
 *  reading
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to <tt>BinaryStdIn</tt> with
 *  calls
...
public final class BinaryStdIn {
    ...
    private static int N;                 // number of bits left in
                                          // buffer
    ...
    /**
     * Close this input stream and release any associated system
     * resources.
     */
    ...
    /**
     * Read the next bit of data from standard input and return as a
     * boolean.
     * @return the next bit of data from standard input as a
     * <tt>boolean</tt>
    ...
    /**
     * Read the next 8 bits from standard input and return as an 8-bit
     * char.
    ...
    * to read the next 16 bits as a char, use <tt>readChar(16)</tt>
    ...
    public static char readChar() {
        ...
        x |= (buffer >>> N);
        return (char) (x & 0xff);
        // the above code doesn't quite work for the last character if
        // N = 8
     ...
     * @return the next r bits of data from standard input as a
     * <tt>char</tt>
     * @throws RuntimeException if there are fewer than r bits
     ...
     * <tt>String</tt>
     * @throws RuntimeException if standard input is empty or if the
     * number of bits
    ...
    /**
     * Read the next 16 bits from standard input and return as a
     * 16-bit short.
     * @return the next 16 bits of data from standard input as a
     * <tt>short</tt>
     * @throws RuntimeException if there are fewer than 16 bits
     * available on standard input
     */
    ...
    /**
     * Read the next 64 bits from standard input and return as a
     * 64-bit long.
     * @return the next 64 bits of data from standard input as a
     * <tt>long</tt>
     * @throws RuntimeException if there are fewer than 64 bits
     * available on standard input
     */
    ...
    /**
     * Read the next 32 bits from standard input and return as a
     * 32-bit float.
     * @return the next 32 bits of data from standard input as a
     * <tt>float</tt>
     ...
     * Read the next 8 bits from standard input and return as an 8-bit
     * byte.
     * @return the next 8 bits of data from standard input as a
     * <tt>byte</tt>
    ...
    /**
     * Test client. Reads in a binary input file from standard input
     * and writes
