 ...
 *
 *  Data type for manipulating individual pixels of an image. The
 *  original
 *  image can be read from a file in jpg, gif, or png format, or the
 *  user can create a blank image of a given size. Includes methods
 *  for
 *  displaying the image in a window on the screen or saving to a
 *  file.
 *
 ...
 *  or PNG format, or the user can create a blank image of a given
 *  size.
 *  This class includes methods for displaying the image in a window
 *  on
 *  the screen or saving to a file.
 *  <p>
 *  By default, pixel (x, y) is column x, row y, where (0, 0) is upper
 *  left.
 *  The method setOriginLowerLeft() change the origin to the lower
 *  left.
 *  <p>
 *  For additional documentation, see
 *  <a href="http://introcs.cs.princeton.edu/31datatype">Section
 *  3.1</a> of
...
public final class Picture implements ActionListener {
    ...
    public Picture(String filename) {
        ...
        try {
            ...
            // now try to read from file in same directory as this
            // .class file
            else {
    ...
    /**
     * Create a picture by reading in a .png, .gif, or .jpg from a
     * File.
     */
    ...
    /**
     * Return a JLabel containing this Picture, for embedding in a
     * JPanel,
    ...
    /**
     * Opens a save dialog box when the user selects "Save As" from
     * the menu.
     */
    ...
    /**
     * Test client. Reads a picture specified by the command-line
     * argument,
