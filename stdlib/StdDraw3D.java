 ...
 * 3D Drawing Library
 *
 * Standard Draw 3D is a Java library with the express goal of making
 * it
 ...
 * simple to create three-dimensional models, simulations, and games.
 * Here is a <a href =
 * "http://introcs.cs.princeton.edu/java/stddraw3d">StdDraw3D
 * tutorial</a>
 * and the
 * <a href =
                                 ...
                                 KeyListener, ActionListener, ChangeListener, ComponentListener, WindowFocusListener
{
    ...
    // Singleton for callbacks - avoids generation of extra .class
    // files.
    ...
    private static void initialize () {
        ...
        //frame.getContentPane().setCursor(new
    ...
    // FIX THIS check that adding specular didn't mess up custom
    // shapes (lines, triangles, points)
     ...
     * @throws a RuntimeException if the width or height is 0 or
     * negative.
     */
    ...
    /**
     * Scales the given x-coordinate from user coordinates into 2D
     * pixel coordinates.
     */
    ...
    /**
     * Scales the given y-coordinate from user coordinates into 2D
     * pixel coordinates.
     */
    ...
    /**
     * Scales the given width from user coordinates into 2D pixel
     * coordinates.
     */
    ...
    /**
     * Scales the given height from user coordinates into 2D pixel
     * coordinates.
     */
    ...
    /**
     * Scales the given x-coordinate from 2D pixel coordinates into
     * user coordinates.
     */
    ...
    /**
     * Scales the given y-coordinate from 2D pixel coordinates into
     * user coordinates.
     */
     ...
     * The default is 100 divisons. Decrease this to increase
     * performance.
     * 
    ...
    public static void setPerspectiveProjection (double fov) {
        ...
        //if (view.getProjectionPolicy() ==
        //View.PERSPECTIVE_PROJECTION) return;
    }
    ...
    /**
     * Sets the background image to the given filename, scaled to fit
     * the window.
     * 
    ...
    //     public static void playPointSound (String filename,
    //     Vector3D position, double volume, boolean loop) {
    // 
    //         MediaContainer mc = new MediaContainer("file:" +
    //         filename);
    //         mc.setCacheEnable(true);
    // 
    ...
    /**
     * Adds the default lighting to the scene, called automatically at
     * startup.
     */
    ...
    /**
     * Adds a directional light of color col which appears to come
     * from (x, y, z).
     */
    ...
    /**
     * Adds a directional light of color col which shines in the
     ...
     * Useful when
     * drawing a complicated scene once and then exploring without
     * redrawing.
    ...
    /**
     * Renders the drawn 3D objects to the screen, but not the
     * overlay.
     */
    ...
    /**
     * Draws a sphere at (x, y, z) with radius r and axial rotations
     * (xA, yA, zA).
     */
    ...
    /**
     * Draws a sphere at (x, y, z) with radius r and a texture from
     * imageURL.
     */
    ...
    /**
     * Draws a sphere at (x, y, z) with radius r, axial rotations (xA,
    ...
    /**
     * Draws a wireframe sphere at (x, y, z) with radius r and axial
     * rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws an ellipsoid at (x, y, z) with dimensions (w, h, d) and a
    ...
    /**
     * Draws an ellipsoid at (x, y, z) with dimensions (w, h, d),
     * axial rotations (xA, yA, zA), and a texture from imageURL.
     */
    ...
    /**
     * Draws a wireframe ellipsoid at (x, y, z) with dimensions (w, h,
     * d).
     */
    ...
    /**
     * Draws a wireframe ellipsoid at (x, y, z) with dimensions (w, h,
     * d) and axial rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a cube at (x, y, z) with radius r and axial rotations
     * (xA, yA, zA).
     */
    ...
    /**
     * Draws a cube at (x, y, z) with radius r and a texture from
     * imageURL.
     */   
    ...
    /**
     * Draws a cube at (x, y, z) with radius r, axial rotations (xA,
     * yA, zA), and a texture from imageURL.
     */
    ...
    /**
     * Draws a box at (x, y, z) with dimensions (w, h, d) and axial
     * rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a box at (x, y, z) with dimensions (w, h, d) and a
     * texture from imageURL.
     */
    ...
    /**
     * Draws a box at (x, y, z) with dimensions (w, h, d), axial
    ...
    /**
     * Draws a cylinder at (x, y, z) with radius r, height h, and
    ...
    /**
     * Draws a cylinder at (x, y, z) with radius r, height h, and a
     * texture from imageURL.
     */
    ...
    /**
     * Draws a cylinder at (x, y, z) with radius r, height h, axial
     * rotations (xA, yA, zA), and a texture from imageURL.
     */
    ...
    /**
     * Draws a wireframe cylinder at (x, y, z) with radius r and
     * height h.
     */
    ...
    /**
     * Draws a wireframe cylinder at (x, y, z) with radius r, height
     * h, and axial rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a cone at (x, y, z) with radius r, height h, and axial
     * rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a cone at (x, y, z) with radius r, height h, and a
     * texture from imageURL.
     */
    ...
    /**
     * Draws a cone at (x, y, z) with radius r, height h, axial
     * rotations (xA, yA, zA), and a texture from imageURL.
     */
    ...
    /**
     * Draws a wireframe cone at (x, y, z) with radius r, height h,
     * and axial rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a Java 3D Primitive object at (x, y, z) with axial
     * rotations (xA, yA, zA).
     */
    ...
    /**
     * Draws a set of points at the given coordinates with the given
     * colors. 
     * For example, the first point is at (x[0], y[0], z[0]) with
     * color colors[0].
     * Much more efficient than drawing individual points.
     */
    ...
    /**
     * Draws a set of connected lines. For example, the first line is
     * from (x[0], y[0], z[0]) to
     * (x[1], y[1], z[1]), and the second line is from (x[1], y[1],
     * z[1]) to (x[2], y[2], z[2]).
    ...
    /**
     * Draws a cylindrical tube of radius r from vertex (x1, y1, z1)
     * to vertex (x2, y2, z2).
     */
    ...
    /**
     * Draws a series of cylindrical tubes of radius r, with vertices
     * (x, y, z).
     */
    ...
    /**
     * Draws a filled polygon with the given vertices. The vertices
     * should be planar for a
    ...
    /**
     * Draws the triangulated outline of a polygon with the given
     * vertices.
     */
    ...
    /**
     * Draws a polygon with the given vertices, which is filled or
     * outlined based on the argument.
     * 
    ...
    /**
     * Draws triangles which are defined by x1=points[i][0],
     * y1=points[i][1], z1=points[i][2], x2=points[i][3], etc.
     * All of the points will be the width and color specified by the
     * setPenColor and setPenWidth methods.
     * @param points an array of the points to be connected.  The
     * first dimension is
    ...
    /**
     * Draws a set of triangles, each with the specified color. There
     * should be one 
     * color for each triangle. This is much more efficient than
     * drawing individual
     * triangles.
     */
    ...
    /**
     * Draws a 3D text object at (x, y, z). Uses the pen font, color,
     * and transparency.
     */
    ...
    /**
     * Draws a 3D text object at (x, y, z) with Euler rotation angles
     * (xA, yA, zA).
     ...
     * 
     * @param polygonFill Polygon fill properties, specified by Java
     * 3D.
     */
    ...
    /**
     * Draws a filled ellipse with given semimajor and semiminor axes,
     * centered on (x, y).
     */
    ...
    /**
     * Draws an arc of radius r, centered on (x, y), from angle1 to
     * angle2 (in degrees).
     */
    ...
    /**
     * Draws a rectangle of given half width and half height, centered
     * on (x, y).
     */
    ...
    /**
     * Draws a filled rectangle of given half width and half height,
     * centered on (x, y).
     */
    ...
    /**
     * Writes the given text string in the current font, centered on
     * (x, y) and
    ...
    /**
     * Write the given text string in the current font, left-aligned
     * at (x, y).
     */
    ...
    /**
     * Write the given text string in the current font, right-aligned
     * at (x, y).
     */
    ...
    /**
     * Draw picture (gif, jpg, or png) centered on (x, y), rescaled to
     * w-by-h.
     */
    ...
    public static void saveScene3D (String filename) {
        ...
        File file = new File(filename);
        //System.out.println("on: " + onscreenGroup.numChildren() + "
        //off: " + offscreenGroup.numChildren());
        ...
        //catch (NamedObjectException noe)         {
        //noe.printStackTrace(); } 
    }
    ...
    public static void loadScene3D (String filename) {
        ...
        try {
            ...
            //BranchGroup bg = (BranchGroup)
            //reader.getNamedObject("rendered");
        ...
        //catch (ObjectNotLoadedException onle)    {
    ...
    /**
     * Private class that represents anything that can be moved and
     * rotated.
     */
    ...
    /**
     * The camera can be controlled with the static functions already
     * listed in 
     * this reference. However, much more advanced control of the
     * camera can be 
     * obtained by manipulating the Camera object. The Camera is
     * basically 
     * equivalent to a Shape with a couple of extra functions, so it
     * can be moved
     * and rotated just like a Shape. This functionality works well
     * with 
    ...
    /**
     * Everything three-dimensional you draw in your scene from
     * spheres to 
     * points to 3D text is actually a Shape object. When you call a
     * drawing 
     * function, it always returns a Shape object. If you keep a
     * reference to
     * this object, you can manipulate the already drawn Shape instead
     * of 
     * clearing and redrawing it, which is a much more powerful and
     * more 
    ...
    public static class Shape extends Transformable {
        ...
        //             Transform3D t = getTransform();
        //             throw new
        //             UnsupportedOperationException("Doesn't work
        //             with rotation!");
        //             setTransform(t);
        //         }
    ...
    */
    ...
    public static class Vector3D { 
        ...
        */
        ...
        /**
         * Returns the smallest angle between this and that vector, in
         * DEGREES.
         * 
        ...
        /**
         * Draws a line representation of this vector, from the given
         * origin.
         * 
        ...
        public void drawLine (Vector3D origin) {
            ...
            StdDraw3D.line(origin.x, origin.y, origin.z, end.x, end.y,
            end.z);
        } 
        */
    }
